...
G0(C,k1){!u?tmv(t,r,w+T(v),n):u<0?tmv(t,zer(t,r,-u),w,n+u):zer(t,tmv(t,r,w+T(v),n0u),u);}
...
G0(C,c3){C *p=r+T(n),*s;I j,i=!u;for(;r<p;w+=T(v_,a+=i{if(j=*a)if(r=tmv(t,s=r,w,v),--j)r=tmv(t,r,s,j*v);}
...
extern I ind(),ran(),not(),neg(),aab(),sgn(),cln(),flr(),rec(),aen(),aln(),pit(),cir(),c_x(),s_c(),dtr(),
 ds(),rs(),sc(),os(),is(),sqr(),dea(),mat(),ncd(),dcd(),dis(),raz(),prt(),pct(),pen(),gz(),
 dep(),mat(),fnd(),mem(),upg(),dng(),mmd(),dmd(),det(),pic(),bi(),bo(),mth(),dth(),exm(),sg(),cv(),rot(),bin(),dot(),undot(0;
I(*P1[])()={ st,ts,ic,sgn,cln,flr,neg,rec,aab,enc,
               dis,  n,  n,upg,dng,aen,aln,ran,tra,iot,
               siz,sha,rav,not,rev, sg,out,upg,dng,dep,
               c_s,s_c,  n,  n,  v,pct,raz,mmd,rdc,pit,
