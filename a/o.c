...
H2(prt){A z;I0{i d[9],j=*a->p,k=*w->d,r=w->r;if(!r)R j==1?rsh(w,1,a->p):(q=7,0);
 ...
 d[1]=-j,*d=k+j+1;Q(*d<0,8)Q(ga(t=w->t,r+1,*d*d[1]*(v=tr(r-1,d+2)),d))C2(lag)}}
H1(pct){A a;I i=0,k=0,n=a->n,*p;I1 W(a->c==1?(A)ic(a):gv(It,n))
...
I rk(f,r,a,w)I ; A r,a,w;{A z,*p;XA;C *pp,*ap,*wp;I wt,wr,wn,*wd,n,t,i,j,k,d[9],rw,ra,
